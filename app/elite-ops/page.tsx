...
const EliteOpsPage = () => {
  ...
  const contacts = [
    ...
    {
      name: 'Aaron Alan',
      title: 'Chief Badass Officer at PB',
      emoji: '🇺🇸🔥',
    ...
    <div className="min-h-screen bg-black text-white relative overflow-hidden">
      ...
      <div className="relative z-10 container mx-auto px-4 py-12">
        ...
        <div className="flex justify-center gap-4 mt-12">
          <Link 
            href="/realtime-chat" 
            className="px-6 py-2 bg-gradient-to-r from-blue-500 to-cyan-500 text-white rounded-lg 
              hover:from-blue-600 hover:to-cyan-600 transition-all duration-300 shadow-lg hover:shadow-cyan-500/50"
          >
            Voice Chat →
          </Link>
          <Link 
            href="/Hales-Ai_Quantum_Code" 
            className="px-6 py-2 bg-gradient-to-r from-purple-500 to-pink-500 text-white rounded-lg 
              hover:from-purple-600 hover:to-pink-600 transition-all duration-300 shadow-lg hover:shadow-pink-500/50"
          >
            Quantum Code →
          </Link>
          <Link 
            href="/" 
            className="px-6 py-2 bg-gradient-to-r from-emerald-500 to-teal-500 text-white rounded-lg 
              hover:from-emerald-600 hover:to-teal-600 transition-all duration-300 shadow-lg hover:shadow-teal-500/50"
          >
            ← Back Home
          </Link>
        </div>

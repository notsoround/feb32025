  ...
  return (
    <html lang="en">
      <body className={inter.className}>
        <script id="noiseVertexShader" type="x-shader/x-vertex" data-type="shader" dangerouslySetInnerHTML={{
          __html: `
        ...
        <script id="fragmentShader" type="x-shader/x-vertex" data-type="shader" dangerouslySetInnerHTML={{
          __html: `
            varying vec3 vNormal;
            uniform float time;
            uniform float RGBr;
